...
var ob, obGroup, blueobAni, blueobImg;
...
function preload(){
  ...
  blueobAni = loadAnimation("Images/blueob.PNG", "Images/blueob2.PNG");
  blueobImg = loadImage("/Images/flatob.png");
...
function setup(){
 ...
 ob = createSprite(width,height-150,20,20);
 ob.addAnimation("xyz", blueobAni);
 ob.scale = 2;
